...
const NFT_GPU_WWW = "https://www.xpowermine.com/nfts/gpu/{id}.json";
...
describe("XPowerNft", async function () {
  ...
  describe("mint", async function () {
    it("should mint XPOW for amount=3", async function () {
      await mintXPow(3);
    });
  ...
  describe("mint-batch", async function () {
    it("should mint XPOW for amount=1", async function () {
      await mintXPow(3);
    });
  ...
  describe("setURI", async function () {
    it("should set new URI", async function () {
      ...
      await xpower_nft.setURI(NFT_GPU_WWW);
      const nft_url = await xpower_nft.uri(nft_id);
      expect(nft_url).to.eq(NFT_GPU_WWW);
    });
