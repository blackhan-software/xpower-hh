...
describe("APower Migration", async function () {
  ...
  beforeEach(async function () {
    AThorOld = await ethers.getContractFactory("APowerThorOldTest36");
    AThorNew = await ethers.getContractFactory("APowerThorTest");
    XThorOld = await ethers.getContractFactory("XPowerThorOldTest36");
    XThorNew = await ethers.getContractFactory("XPowerThorTest");
    ALokiOld = await ethers.getContractFactory("APowerLokiOldTest36");
    ALokiNew = await ethers.getContractFactory("APowerLokiTest");
    XLokiOld = await ethers.getContractFactory("XPowerLokiOldTest36");
    XLokiNew = await ethers.getContractFactory("XPowerLokiTest");
    AOdinOld = await ethers.getContractFactory("APowerOdinOldTest36");
    AOdinNew = await ethers.getContractFactory("APowerOdinTest");
    XOdinOld = await ethers.getContractFactory("XPowerOdinOldTest36");
