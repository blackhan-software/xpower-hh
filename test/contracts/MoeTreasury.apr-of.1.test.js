...
describe("MoeTreasury", async function () {
  ...
  describe("apr-of (i.e rewards ~ nft-level)", async function () {
    it("should return 0.000000[%] for nft-level=00", async function () {
      Expect(await mty.aprOf(202100)).to.be.approximately(0x000_000, 1);
    });
    it("should return 1.000000[%] for nft-level=03", async function () {
      Expect(await mty.aprOf(202103)).to.be.approximately(1_000_000, 1);
    });
    it("should return 2.000000[%] for nft-level=06", async function () {
      Expect(await mty.aprOf(202106)).to.be.approximately(2_000_000, 1);
    });
    it("should return 3.000000[%] for nft-level=09", async function () {
      Expect(await mty.aprOf(202109)).to.be.approximately(3_000_000, 1);
    });
    it("should return 4.000000[%] for nft-level=12", async function () {
      Expect(await mty.aprOf(202112)).to.be.approximately(4_000_000, 1);
    });
    it("should return 5.000000[%] for nft-level=15", async function () {
      Expect(await mty.aprOf(202115)).to.be.approximately(5_000_000, 1);
    });
    it("should return 6.000000[%] for nft-level=18", async function () {
      Expect(await mty.aprOf(202118)).to.be.approximately(6_000_000, 1);
    });
    it("should return 7.000000[%] for nft-level=21", async function () {
      Expect(await mty.aprOf(202121)).to.be.approximately(7_000_000, 1);
    });
    it("should return 8.000000[%] for nft-level=24", async function () {
      Expect(await mty.aprOf(202124)).to.be.approximately(8_000_000, 1);
    });
  });
  describe("set-apr: **init** at 1[%]", async function () {
    it("should reparameterize", async function () {
      ...
      expect(await mty.setAPR(202103, [0, 3, 1_000_000])).to.not.eq(undefined);
      expect(await mty.setAPR(202106, [0, 3, 1_000_000])).to.not.eq(undefined);
      expect(await mty.setAPR(202109, [0, 3, 1_000_000])).to.not.eq(undefined);
      expect(await mty.setAPR(202112, [0, 3, 1_000_000])).to.not.eq(undefined);
      expect(await mty.setAPR(202115, [0, 3, 1_000_000])).to.not.eq(undefined);
      expect(await mty.setAPR(202118, [0, 3, 1_000_000])).to.not.eq(undefined);
      expect(await mty.setAPR(202121, [0, 3, 1_000_000])).to.not.eq(undefined);
      expect(await mty.setAPR(202124, [0, 3, 1_000_000])).to.not.eq(undefined);
    });
  });
  describe("set-apr (double from 1[%] to 2[%])", async function () {
    ...
    it("should *not* reparameterize (too large)", async function () {
      await mty.grantRole(mty.APR_ROLE(), addresses[0]);
      expect(
        await mty.setAPR(202103, [0, 3, 2_000_001]).catch((ex) => {
    ...
    it("should *not* reparameterize (too large)", async function () {
      await mty.grantRole(mty.APR_ROLE(), addresses[0]);
      expect(
        await mty.setAPR(202103, [1_000_001, 3, 1_000_000]).catch((ex) => {
          const m = ex.message.match(/invalid change: too large/);
          if (m === null) console.debug(ex);
          expect(m).to.be.not.null;
        })
    ...
    it("should *not* reparameterize (too small)", async function () {
      await mty.grantRole(mty.APR_ROLE(), addresses[0]);
      expect(
        await mty.setAPR(202103, [0, 3, 499999]).catch((ex) => {
    ...
    it("should reparameterize APR at 2.000000[%]", async function () {
      await mty.grantRole(mty.APR_ROLE(), addresses[0]);
      expect(await mty.setAPR(202103, [0, 3, 2_000_000])).to.not.eq(undefined);
      expect(await mty.setAPR(202106, [0, 3, 2_000_000])).to.not.eq(undefined);
      expect(await mty.setAPR(202109, [0, 3, 2_000_000])).to.not.eq(undefined);
      expect(await mty.setAPR(202112, [0, 3, 2_000_000])).to.not.eq(undefined);
      expect(await mty.setAPR(202115, [0, 3, 2_000_000])).to.not.eq(undefined);
      expect(await mty.setAPR(202118, [0, 3, 2_000_000])).to.not.eq(undefined);
      expect(await mty.setAPR(202121, [0, 3, 2_000_000])).to.not.eq(undefined);
      expect(await mty.setAPR(202124, [0, 3, 2_000_000])).to.not.eq(undefined);
    });
    it("should *not* reparameterize (too frequent)", async function () {
      await mty.grantRole(mty.APR_ROLE(), addresses[0]);
      expect(
        await mty.setAPR(202103, [0, 3, 1_000_000]).catch((ex) => {
  ...
  describe("apr-of (i.e rewards ~ nft-level × time)", async function () {
    ...
    it("should return 1.200000[%] for nft-level=03", async function () {
      Expect(await mty.aprOf(202103)).to.be.approximately(1_200_000, 1);
    });
    it("should return 2.400000[%] for nft-level=06", async function () {
      Expect(await mty.aprOf(202106)).to.be.approximately(2_400_000, 1);
    });
    it("should return 3.600000[%] for nft-level=09", async function () {
      Expect(await mty.aprOf(202109)).to.be.approximately(3_600_000, 1);
    });
    it("should return 4.800000[%] for nft-level=12", async function () {
      Expect(await mty.aprOf(202112)).to.be.approximately(4_800_000, 1);
    });
    it("should return 6.000000[%] for nft-level=15", async function () {
      Expect(await mty.aprOf(202115)).to.be.approximately(6_000_000, 1);
    });
    it("should return 7.200000[%] for nft-level=18", async function () {
      Expect(await mty.aprOf(202118)).to.be.approximately(7_200_000, 1);
    });
    it("should return 8.399999[%] for nft-level=21", async function () {
      Expect(await mty.aprOf(202121)).to.be.approximately(8_399_999, 1);
    });
    it("should return 9.599999[%] for nft-level=24", async function () {
      Expect(await mty.aprOf(202124)).to.be.approximately(9_599_999, 1);
    });
  });
  describe("apr-of (i.e rewards ~ nft-level × time)", async function () {
    it(`should forward time by 0.25 year`, async function () {
    ...
    it("should return 1.333333[%] for nft-level=03", async function () {
      Expect(await mty.aprOf(202103)).to.be.approximately(1_333_333, 1);
    });
    it("should return 2.666666[%] for nft-level=06", async function () {
      Expect(await mty.aprOf(202106)).to.be.approximately(2_666_666, 1);
    });
    it("should return 3.999999[%] for nft-level=09", async function () {
      Expect(await mty.aprOf(202109)).to.be.approximately(3_999_999, 1);
    });
    it("should return 5_333333[%] for nft-level=12", async function () {
      Expect(await mty.aprOf(202112)).to.be.approximately(5_333_333, 1);
    });
    it("should return 6.666666[%] for nft-level=15", async function () {
      Expect(await mty.aprOf(202115)).to.be.approximately(6_666_666, 1);
    });
    it("should return 7.999999[%] for nft-level=18", async function () {
      Expect(await mty.aprOf(202118)).to.be.approximately(7_999_999, 1);
    });
    it("should return 9.333332[%] for nft-level=21", async function () {
      Expect(await mty.aprOf(202121)).to.be.approximately(9_333_332, 1);
    });
    it("should return 10.666666[%] for nft-level=24", async function () {
      Expect(await mty.aprOf(202124)).to.be.approximately(10_666_666, 1);
    });
  });
  describe("apr-of (i.e rewards ~ nft-level × time)", async function () {
    it(`should forward time by 0.25 year`, async function () {
    ...
    it("should return 1.428571[%] for nft-level=03", async function () {
      Expect(await mty.aprOf(202103)).to.be.approximately(1_428_571, 1);
    });
    it("should return 2.857142[%] for nft-level=06", async function () {
      Expect(await mty.aprOf(202106)).to.be.approximately(2_857_142, 1);
    });
    it("should return 4.285714[%] for nft-level=09", async function () {
      Expect(await mty.aprOf(202109)).to.be.approximately(4_285_714, 1);
    });
    it("should return 5.714285[%] for nft-level=12", async function () {
      Expect(await mty.aprOf(202112)).to.be.approximately(5_714_285, 1);
    });
    it("should return 7.142856[%] for nft-level=15", async function () {
      Expect(await mty.aprOf(202115)).to.be.approximately(7_142_856, 1);
    });
    it("should return 8_571428[%] for nft-level=18", async function () {
      Expect(await mty.aprOf(202118)).to.be.approximately(8_571_428, 1);
    });
    it("should return 9.999999[%] for nft-level=21", async function () {
      Expect(await mty.aprOf(202121)).to.be.approximately(9_999_999, 1);
    });
    it("should return 11.428570[%] for nft-level=24", async function () {
      Expect(await mty.aprOf(202124)).to.be.approximately(11_428_570, 1);
    });
  });
  describe("apr-of (i.e rewards ~ nft-level × time)", async function () {
    ...
    it("should return 1.499999[%] for nft-level=03", async function () {
      Expect(await mty.aprOf(202103)).to.be.approximately(1_499_999, 1);
    });
    it("should return 2.999999[%] for nft-level=06", async function () {
      Expect(await mty.aprOf(202106)).to.be.approximately(2_999_999, 1);
    });
    it("should return 4.499999[%] for nft-level=09", async function () {
      Expect(await mty.aprOf(202109)).to.be.approximately(4_499_999, 1);
    });
    it("should return 5.999999[%] for nft-level=12", async function () {
      Expect(await mty.aprOf(202112)).to.be.approximately(5_999_999, 1);
    });
    it("should return 7.499999[%] for nft-level=15", async function () {
      Expect(await mty.aprOf(202115)).to.be.approximately(7_499_999, 1);
    });
    it("should return 8.999999[%] for nft-level=18", async function () {
      Expect(await mty.aprOf(202118)).to.be.approximately(8_999_999, 1);
    });
    it("should return 10.499999[%] for nft-level=21", async function () {
      Expect(await mty.aprOf(202121)).to.be.approximately(10_499_999, 1);
    });
    it("should return 11.999999[%] for nft-level=24", async function () {
      Expect(await mty.aprOf(202124)).to.be.approximately(11_999_999, 1);
    });
  });
  describe("apr-of (i.e rewards ~ nft-level × time)", async function () {
    ...
    it("should return 1.999000[%] for nft-level=03", async function () {
      Expect(await mty.aprOf(202103)).to.be.approximately(1_999_000, 1);
    });
    it("should return 3.998001[%] for nft-level=06", async function () {
      Expect(await mty.aprOf(202106)).to.be.approximately(3_998_001, 1);
    });
    it("should return 5.997002[%] for nft-level=09", async function () {
      Expect(await mty.aprOf(202109)).to.be.approximately(5_997_002, 1);
    });
    it("should return 7.996003[%] for nft-level=12", async function () {
      Expect(await mty.aprOf(202112)).to.be.approximately(7_996_003, 1);
    });
    it("should return 9.995004[%] for nft-level=15", async function () {
      Expect(await mty.aprOf(202115)).to.be.approximately(9_995_004, 1);
    });
    it("should return 11.994005[%] for nft-level=18", async function () {
      Expect(await mty.aprOf(202118)).to.be.approximately(11_994_005, 1);
    });
    it("should return 13.993006[%] for nft-level=21", async function () {
      Expect(await mty.aprOf(202121)).to.be.approximately(13_993_006, 1);
    });
    it("should return 15.992007[%] for nft-level=24", async function () {
      Expect(await mty.aprOf(202124)).to.be.approximately(15_992_007, 1);
    });
  });
});
