...
describe("MoeTreasury", async function () {
  ...
  describe("bonuses-length", async function () {
    it("should return a list of length=0", async function () {
      expect(await mty.bonusesLength(1202103)).to.eq(0);
      expect(await mty.bonusesLength(2202103)).to.eq(0);
      expect(await mty.bonusesLength(3202103)).to.eq(0);
      expect(await mty.bonusesLength(4202103)).to.eq(0);
    });
  });
  ...
  describe("apr-bonus-of (i.e rewards ~ nft-level × time)", async function () {
    ...
    it("should return 0.080000[%] for nft-level=00", async function () {
      expect(await mty.aprBonusOf(ppt.idBy(YEAR, 0, 1))).to.eq(80_000);
    });
    it("should return 0.080000[%] for nft-level=03", async function () {
      expect(await mty.aprBonusOf(ppt.idBy(YEAR, 3, 1))).to.eq(80_000);
    });
    it("should return 0.080000[%] for nft-level=06", async function () {
      expect(await mty.aprBonusOf(ppt.idBy(YEAR, 6, 1))).to.eq(80_000);
    });
    it("should return 0.080000[%] for nft-level=09", async function () {
      expect(await mty.aprBonusOf(ppt.idBy(YEAR, 9, 1))).to.eq(80_000);
    });
    it("should return 0.080000[%] for nft-level=12", async function () {
      expect(await mty.aprBonusOf(ppt.idBy(YEAR, 12, 1))).to.eq(80_000);
    });
    it("should return 0.080000[%] for nft-level=15", async function () {
      expect(await mty.aprBonusOf(ppt.idBy(YEAR, 15, 1))).to.eq(80_000);
    });
    it("should return 0.080000[%] for nft-level=18", async function () {
      expect(await mty.aprBonusOf(ppt.idBy(YEAR, 18, 1))).to.eq(80_000);
    });
    it("should return 0.080000[%] for nft-level=21", async function () {
      expect(await mty.aprBonusOf(ppt.idBy(YEAR, 21, 1))).to.eq(80_000);
    });
    it("should return 0.080000[%] for nft-level=24", async function () {
      expect(await mty.aprBonusOf(ppt.idBy(YEAR, 24, 1))).to.eq(80_000);
    });
  });
  describe("apr-bonus-of (i.e rewards ~ nft-level × time)", async function () {
    it(`should forward time by one year`, async function () {
    ...
    it("should return 0.100000[%] for nft-level=00", async function () {
      expect(await mty.aprBonusOf(ppt.idBy(YEAR, 0, 1))).to.eq(100_000);
    });
    it("should return 0.100000[%] for nft-level=03", async function () {
      expect(await mty.aprBonusOf(ppt.idBy(YEAR, 3, 1))).to.eq(100_000);
    });
    it("should return 0.100000[%] for nft-level=06", async function () {
      expect(await mty.aprBonusOf(ppt.idBy(YEAR, 6, 1))).to.eq(100_000);
    });
    it("should return 0.100000[%] for nft-level=09", async function () {
      expect(await mty.aprBonusOf(ppt.idBy(YEAR, 9, 1))).to.eq(100_000);
    });
    it("should return 0.100000[%] for nft-level=12", async function () {
      expect(await mty.aprBonusOf(ppt.idBy(YEAR, 12, 1))).to.eq(100_000);
    });
    it("should return 0.100000[%] for nft-level=15", async function () {
      expect(await mty.aprBonusOf(ppt.idBy(YEAR, 15, 1))).to.eq(100_000);
    });
    it("should return 0.100000[%] for nft-level=18", async function () {
      expect(await mty.aprBonusOf(ppt.idBy(YEAR, 18, 1))).to.eq(100_000);
    });
    it("should return 0.100000[%] for nft-level=21", async function () {
      expect(await mty.aprBonusOf(ppt.idBy(YEAR, 21, 1))).to.eq(100_000);
    });
    it("should return 0.100000[%] for nft-level=24", async function () {
      expect(await mty.aprBonusOf(ppt.idBy(YEAR, 24, 1))).to.eq(100_000);
    });
  });
  describe("apr-bonus-of (i.e rewards ~ nft-level × time)", async function () {
    it(`should forward time by one year`, async function () {
    ...
    it("should return 0.120000[%] for nft-level=00", async function () {
      expect(await mty.aprBonusOf(ppt.idBy(YEAR, 0, 1))).to.eq(120_000);
    });
    it("should return 0.120000[%] for nft-level=03", async function () {
      expect(await mty.aprBonusOf(ppt.idBy(YEAR, 3, 1))).to.eq(120_000);
    });
    it("should return 0.120000[%] for nft-level=06", async function () {
      expect(await mty.aprBonusOf(ppt.idBy(YEAR, 6, 1))).to.eq(120_000);
    });
    it("should return 0.120000[%] for nft-level=09", async function () {
      expect(await mty.aprBonusOf(ppt.idBy(YEAR, 9, 1))).to.eq(120_000);
    });
    it("should return 0.120000[%] for nft-level=12", async function () {
      expect(await mty.aprBonusOf(ppt.idBy(YEAR, 12, 1))).to.eq(120_000);
    });
    it("should return 0.120000[%] for nft-level=15", async function () {
      expect(await mty.aprBonusOf(ppt.idBy(YEAR, 15, 1))).to.eq(120_000);
    });
    it("should return 0.120000[%] for nft-level=18", async function () {
      expect(await mty.aprBonusOf(ppt.idBy(YEAR, 18, 1))).to.eq(120_000);
    });
    it("should return 0.120000[%] for nft-level=21", async function () {
      expect(await mty.aprBonusOf(ppt.idBy(YEAR, 21, 1))).to.eq(120_000);
    });
    it("should return 0.120000[%] for nft-level=24", async function () {
      expect(await mty.aprBonusOf(ppt.idBy(YEAR, 24, 1))).to.eq(120_000);
    });
  });
  describe("apr-bonus-of (i.e rewards ~ nft-level × time)", async function () {
    ...
    it("should return 20.060000[%] for nft-level=00", async function () {
      expect(await mty.aprBonusOf(ppt.idBy(YEAR, 0, 1))).to.eq(20_060_000);
    });
    it("should return 20.060000[%] for nft-level=03", async function () {
      expect(await mty.aprBonusOf(ppt.idBy(YEAR, 3, 1))).to.eq(20_060_000);
    });
    it("should return 20.060000[%] for nft-level=06", async function () {
      expect(await mty.aprBonusOf(ppt.idBy(YEAR, 6, 1))).to.eq(20_060_000);
    });
    it("should return 20.060000[%] for nft-level=09", async function () {
      expect(await mty.aprBonusOf(ppt.idBy(YEAR, 9, 1))).to.eq(20_060_000);
    });
    it("should return 20.060000[%] for nft-level=12", async function () {
      expect(await mty.aprBonusOf(ppt.idBy(YEAR, 12, 1))).to.eq(20_060_000);
    });
    it("should return 20.060000[%] for nft-level=15", async function () {
      expect(await mty.aprBonusOf(ppt.idBy(YEAR, 15, 1))).to.eq(20_060_000);
    });
    it("should return 20.060000[%] for nft-level=18", async function () {
      expect(await mty.aprBonusOf(ppt.idBy(YEAR, 18, 1))).to.eq(20_060_000);
    });
    it("should return 20.060000[%] for nft-level=21", async function () {
      expect(await mty.aprBonusOf(ppt.idBy(YEAR, 21, 1))).to.eq(20_060_000);
    });
    it("should return 20.060000[%] for nft-level=24", async function () {
      expect(await mty.aprBonusOf(ppt.idBy(YEAR, 24, 1))).to.eq(20_060_000);
    });
  });
  describe("bonuses-length", async function () {
    it("should return a list of length=1", async function () {
      expect(await mty.bonusesLength(1202103)).to.eq(1);
    });
    it("should return a list of length=0", async function () {
      expect(await mty.bonusesLength(2202103)).to.eq(0);
      expect(await mty.bonusesLength(3202103)).to.eq(0);
