...
async function main() {
  ...
  const nft_link = process.env.XPOW_NFT_V8a;
  assert(nft_link, "missing XPOW_NFT_V8a");
  ...
  const mty_link = process.env.XPOW_MTY_V8a;
  assert(mty_link, "missing XPOW_MTY_V8a");
  //
