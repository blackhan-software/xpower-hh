...
async function main() {
  ...
  const nft_link = process.env.XPOW_NFT_V9a;
  assert(nft_link, "missing XPOW_NFT_V9a");
  ...
  const mty_link = process.env.XPOW_MTY_V9a;
  assert(mty_link, "missing XPOW_MTY_V9a");
  //
  ...
  console.log(`XPOW_PTY_V9a=${nty.target}`);
  //
  // verify contract(s):
  //
