...
async function main() {
  ...
  const nft_link = process.env.XPOW_NFT_V9b;
  assert(nft_link, "missing XPOW_NFT_V9b");
  ...
  const mty_link = process.env.XPOW_MTY_V9b;
  assert(mty_link, "missing XPOW_MTY_V9b");
  //
  ...
  console.log(`XPOW_PTY_V9b=${nty.target}`);
  //
  // verify contract(s):
  //
