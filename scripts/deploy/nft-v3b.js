...
async function main() {
  ...
  const thor_nft_base = process.env.THOR_NFT_V3a;
  assert(thor_nft_base, "missing THOR_NFT_V3a");
  const loki_nft_base = process.env.LOKI_NFT_V3a;
  assert(loki_nft_base, "missing LOKI_NFT_V3a");
  const odin_nft_base = process.env.ODIN_NFT_V3a;
  assert(odin_nft_base, "missing ODIN_NFT_V3a");
  // addresses XPower[New]
  const thor_moe_link = process.env.THOR_MOE_V3a;
  assert(thor_moe_link, "missing THOR_MOE_V3a");
  const loki_moe_link = process.env.LOKI_MOE_V3a;
  assert(loki_moe_link, "missing LOKI_MOE_V3a");
  const odin_moe_link = process.env.ODIN_MOE_V3a;
  assert(odin_moe_link, "missing ODIN_MOE_V3a");
  ...
  console.log(`THOR_NFT_V3b=${thor_nft.address}`);
  //
  ...
  console.log(`LOKI_NFT_V3b=${loki_nft.address}`);
  //
  ...
  console.log(`ODIN_NFT_V3b=${odin_nft.address}`);
}
