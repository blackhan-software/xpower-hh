...
async function main() {
  ...
  const nft_link = process.env.XPOW_NFT_V6a;
  assert(nft_link, "missing XPOW_NFT_V6a");
  ...
  const mty_link = process.env.XPOW_MTY_V6a;
  assert(mty_link, "missing XPOW_MTY_V6a");
  //
  ...
  console.log(`XPOW_PTY_V6a=${nty.target}`);
  //
  // verify contract(s):
  //
