...
async function main() {
  ...
  const sov_link = process.env.XPOW_SOV_V5c;
  assert(sov_link, "missing XPOW_SOV_V5c");
  // addresses XPowerPpt[New]
  const ppt_link = process.env.XPOW_PPT_V5c;
  assert(ppt_link, "missing XPOW_PPT_V5c");
  //
