...
async function main() {
  ...
  const nft_link = process.env.XPOW_NFT_V5a;
  assert(nft_link, "missing XPOW_NFT_V5a");
  ...
  const mty_link = process.env.XPOW_MTY_V5a;
  assert(mty_link, "missing XPOW_MTY_V5a");
  //
