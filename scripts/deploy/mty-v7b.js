...
async function main() {
  ...
  const moe_link = process.env.XPOW_MOE_V7b;
  assert(moe_link, "missing XPOW_MOE_V7b");
  // addresses APower[New]
  const sov_link = process.env.XPOW_SOV_V7b;
  assert(sov_link, "missing XPOW_SOV_V7b");
  ...
  console.log(`XPOW_MTY_V7b=${mty.target}`);
  //
  // verify contract(s):
  //
