...
async function main() {
  ...
  const xpow_nft_link = process.env.XPOW_NFT_V6b;
  assert(xpow_nft_link, "missing XPOW_NFT_V6b");
  ...
  const xpow_mty_link = process.env.XPOW_MTY_V6b;
  assert(xpow_mty_link, "missing XPOW_MTY_V6b");
  //
