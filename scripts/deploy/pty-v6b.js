...
async function main() {
  ...
  const nft_link = process.env.XPOW_NFT_V6b;
  assert(nft_link, "missing XPOW_NFT_V6b");
  // addresses XPowerPpt[New]
  const ppt_link = process.env.XPOW_PPT_V6b;
  assert(ppt_link, "missing XPOW_PPT_V6b");
  // addresses MoeTreasury[New]
  const mty_link = process.env.XPOW_MTY_V6b;
  assert(mty_link, "missing XPOW_MTY_V6b");
  //
