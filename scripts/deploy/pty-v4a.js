...
async function main() {
  ...
  const nft_link = process.env.XPOW_NFT_V4a;
  assert(nft_link, "missing XPOW_NFT_V4a");
  ...
  const mty_link = process.env.XPOW_MTY_V4a;
  assert(mty_link, "missing XPOW_MTY_V4a");
  //
