...
async function main() {
  ...
  const para_base = process.env.XPOWER_NFT_ADDRESS_PARA_V2;
  assert(para_base, "missing XPOWER_NFT_ADDRESS_PARA_V2");
  const aqch_base = process.env.XPOWER_NFT_ADDRESS_AQCH_V2;
  assert(aqch_base, "missing XPOWER_NFT_ADDRESS_AQCH_V2");
  const qrsh_base = process.env.XPOWER_NFT_ADDRESS_QRSH_V2;
  assert(qrsh_base, "missing XPOWER_NFT_ADDRESS_QRSH_V2");
  //
  ...
  console.log(`XPOWER_NFT_ADDRESS_PARA_V3a=${para.address}`);
  //
  ...
  console.log(`XPOWER_NFT_ADDRESS_AQCH_V3a=${aqch.address}`);
  //
  ...
  console.log(`XPOWER_NFT_ADDRESS_QRSH_V3a=${qrsh.address}`);
}
