...
async function main() {
  ...
  const para_xpower = process.env.PARA_MOE_V4a;
  assert(para_xpower, "missing PARA_MOE_V4a");
  const aqch_xpower = process.env.AQCH_MOE_V4a;
  assert(aqch_xpower, "missing AQCH_MOE_V4a");
  const qrsh_xpower = process.env.QRSH_MOE_V4a;
  assert(qrsh_xpower, "missing QRSH_MOE_V4a");
  ...
  const para_base = process.env.PARA_NFT_V3b;
  assert(para_base, "missing PARA_NFT_V3b");
  const aqch_base = process.env.AQCH_NFT_V3b;
  assert(aqch_base, "missing AQCH_NFT_V3b");
  const qrsh_base = process.env.QRSH_NFT_V3b;
  assert(qrsh_base, "missing QRSH_NFT_V3b");
  //
  ...
  console.log(`PARA_NFT_V4a=${para_nft.address}`);
  //
  ...
  console.log(`AQCH_NFT_V4a=${aqch_nft.address}`);
  //
  ...
  console.log(`QRSH_NFT_V4a=${qrsh_nft.address}`);
}
