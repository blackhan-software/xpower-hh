...
async function main() {
  ...
  const thor_xpower = process.env.THOR_MOE_V4a;
  assert(thor_xpower, "missing THOR_MOE_V4a");
  const loki_xpower = process.env.LOKI_MOE_V4a;
  assert(loki_xpower, "missing LOKI_MOE_V4a");
  const odin_xpower = process.env.ODIN_MOE_V4a;
  assert(odin_xpower, "missing ODIN_MOE_V4a");
  ...
  const thor_base = process.env.THOR_NFT_V3b;
  assert(thor_base, "missing THOR_NFT_V3b");
  const loki_base = process.env.LOKI_NFT_V3b;
  assert(loki_base, "missing LOKI_NFT_V3b");
  const odin_base = process.env.ODIN_NFT_V3b;
  assert(odin_base, "missing ODIN_NFT_V3b");
  //
