...
async function main() {
  ...
  const thor_base = process.env.THOR_NFT_V3a;
  assert(thor_base, "missing THOR_NFT_V3a");
  const loki_base = process.env.LOKI_NFT_V3a;
  assert(loki_base, "missing LOKI_NFT_V3a");
  const odin_base = process.env.ODIN_NFT_V3a;
  assert(odin_base, "missing ODIN_NFT_V3a");
  //
